...
!function () {
    ...
    class Game_Spine {
        ...
        get blendMode() { return this._blendMode = this._blendMode || {}; }
        ...
        setBlendMode(image, mode) {
            this._blendMode = Object.assign({}, this._blendMode);
            this._blendMode[image] = mode;
            return this;
        }
    ...
    class Sprite_Spine extends Sprite {
        ...
        updateBlendMode(spine) {
            if (spine.blendMode != this._blendMode) {
                this._blendMode = spine.blendMode;
                for (let image in this._blendMode) {
                    let slot = this.getSpineSlot(image);
                    if (slot) {
                        slot.blendMode = this._blendMode[image];
                    }
                }
            }
        }
